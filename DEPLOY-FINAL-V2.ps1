# ================================================
# DEPLOY SCRIPT - VentasPro (FINAL AUTO V2)
# ================================================
...
Write-Host "  DEPLOY VENTASPRO - FINAL AUTO V2" -ForegroundColor Cyan
...
$cmd2 = "pm2 restart all || pm2 start server-FINAL.js --name crm-backend"
