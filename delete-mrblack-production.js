...
async function deleteMrBlackRemote() {
    ...
    try {
        ...
        if (clientResult.rows.length === 0) {
            console.log('❌ No se encontró el cliente MR BLACK INC en producción');
            return;
        }
        ...
        console.log('\n✅ Venta de prueba MR BLACK INC eliminada completamente de producción');
