...
export const saveImportData = async (req, res) => {
    ...
    try {
        ...
        for (let batchIndex = 0; batchIndex < totalBatches; batchIndex++) {
            ...
            console.log(`[SAVE] Procesando lote ${batchIndex + 1}/${totalBatches} (filas ${start + 1}-${end})`);
            ...
            try {
                ...
                // Crear/actualizar ventas para este lote
            ...
            // Limpiar stats para el siguiente lote
            clientSalesStats.clear();
        }
