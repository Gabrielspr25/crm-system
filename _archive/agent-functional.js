...
async function main() {
    ...
    try {
        ...
        if (banRes.body.ban_number !== banData.ban_number && banRes.body.account_number !== banData.ban_number && banRes.body.number !== banData.ban_number) {
        ...
        const savedNumber = updateRes.body.ban_number || updateRes.body.account_number || updateRes.body.number;
