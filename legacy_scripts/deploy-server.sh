#!/bin/bash
# Script de deploy con limpieza completa de caché
# Ejecutar en el servidor: bash deploy-server.sh
...
echo ""
echo "⚠️  IMPORTANTE: Abre en modo INCÓGNITO o presiona Ctrl+Shift+R"
